...
class UserProfile(Base):
    ...
    specialization_secondary_name = Column(String(255))
...
class ContentItem(Base):
    ...
    is_active = Column(Boolean, nullable=False, default=True)
    contributor_user_id = Column(Integer)
...
class ContentSubmission(Base):
    ...
    ai_moderation_risk_level = Column(String(20))
    ai_moderation_flags = Column(JSON)
    ai_moderation_suggested_categories = Column(JSON)
    ai_moderation_suggested_specializations = Column(JSON)
    ai_moderation_summary = Column(Text)
    ai_moderation_recommendation = Column(Text)
    ai_moderation_model = Column(String(100))
    ai_moderation_checked_at = Column(DateTime(timezone=True))
